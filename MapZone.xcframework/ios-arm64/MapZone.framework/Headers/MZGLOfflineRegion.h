...
/**
 An object conforming to the `MZGLOfflineRegion` protocol determines which
 resources are required by an `MZGLOfflinePack` object.
 */
@protocol MZGLOfflineRegion <NSObject>
