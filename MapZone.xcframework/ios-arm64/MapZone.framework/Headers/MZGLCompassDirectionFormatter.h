...
/**
 The `MZGLCompassDirectionFormatter` class provides properly formatted
 ...
 the user’s current location, use `MZGLClockDirectionFormatter` instead.
 */
MGL_EXPORT
@interface MZGLCompassDirectionFormatter : NSFormatter
