...
@interface MZGLMapView (IBAdditions)
...
// inspectables declared in MZGLMapView.h are always sorted before those in
// MZGLMapView+IBAdditions.h, due to ASCII sort order.
