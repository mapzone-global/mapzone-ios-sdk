...
/**
 The `MZGLClockDirectionFormatter` class provides properly formatted descriptions
 ...
 irrespective of the user’s orientation, use `MZGLCompassDirectionFormatter`
 instead.
 */
MGL_EXPORT
@interface MZGLClockDirectionFormatter : NSFormatter
