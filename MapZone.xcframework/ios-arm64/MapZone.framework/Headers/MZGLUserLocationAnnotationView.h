...
/** View representing an `MZGLUserLocation` on screen. */
MGL_EXPORT
@interface MZGLUserLocationAnnotationView : MZGLAnnotationView
 ...
 */
@property (nonatomic, readonly, weak, nullable) MZGLMapView *mapView;
 ...
 */
@property (nonatomic, readonly, weak, nullable) MZGLUserLocation *userLocation;
