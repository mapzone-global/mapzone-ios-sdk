...
@class MZGLAttributionInfo;

/**
 Options for `MZGLTileSource` objects.
 */
typedef NSString *MZGLTileSourceOption NS_STRING_ENUM;
...
/**
 ...
 `MZGLTileSourceOptionMaximumZoomLevel`, if specified. The default value for this
 option is 0.
 ...
 specification.
 */
FOUNDATION_EXTERN MGL_EXPORT const MZGLTileSourceOption MZGLTileSourceOptionMinimumZoomLevel;
...
/**
 ...
 The value should be between 0 and 22, inclusive, and less than
 `MZGLTileSourceOptionMinimumZoomLevel`, if specified. The default value for this
 option is 22.
 ...
 specification.
 */
FOUNDATION_EXTERN MGL_EXPORT const MZGLTileSourceOption MZGLTileSourceOptionMaximumZoomLevel;
...
/**
 ...
 specification.
 */
FOUNDATION_EXTERN MGL_EXPORT const MZGLTileSourceOption MZGLTileSourceOptionCoordinateBounds;
...
/**
 ...
 `MZGLTileSourceOptionAttributionInfos` option is specified, this option is
 ignored.
 ...
 specification.
 */
FOUNDATION_EXTERN MGL_EXPORT const MZGLTileSourceOption MZGLTileSourceOptionAttributionHTMLString;

/**
 An array of `MZGLAttributionInfo` objects defining the buttons to be displayed
 ...
 */
FOUNDATION_EXTERN MGL_EXPORT const MZGLTileSourceOption MZGLTileSourceOptionAttributionInfos;
#else
/**
...
/**
 ...
 specification.
 */
FOUNDATION_EXTERN MGL_EXPORT const MZGLTileSourceOption MZGLTileSourceOptionTileCoordinateSystem;
...
/**
 `MZGLTileSource` is a map content source that supplies map tiles to be shown on
 ...
 A tile source is added to an `MZGLStyle` object along with one or more
 `MZGLRasterStyleLayer` or `MZGLVectorStyleLayer` objects. Use a style layer to
 ...
 Create instances of `MZGLRasterTileSource` and `MZGLVectorTileSource` in order
 to use `MZGLTileSource`'s properties and methods. Do not create instances of
 `MZGLTileSource` directly, and do not create your own subclasses of this class.
 */
MGL_EXPORT
@interface MZGLTileSource : MZGLSource
...
/**
 An array of `MZGLAttributionInfo` objects that define the attribution
 ...
 is loaded.
 */
@property (nonatomic, copy, readonly) NSArray<MZGLAttributionInfo *> *attributionInfos;
