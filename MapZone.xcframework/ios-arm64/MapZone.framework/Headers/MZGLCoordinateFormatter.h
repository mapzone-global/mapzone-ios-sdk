...
/**
 The `MZGLCoordinateFormatter` class provides properly formatted descriptions of
 ...
 */
MGL_EXPORT
@interface MZGLCoordinateFormatter : NSFormatter
...
/**
 This method is not supported for the `MZGLCoordinateFormatter` class.
 */
