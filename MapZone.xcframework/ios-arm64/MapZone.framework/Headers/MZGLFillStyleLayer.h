...
/**
 Controls the frame of reference for `MZGLFillStyleLayer.fillTranslation`.

 Values of this type are used in the `MZGLFillStyleLayer.fillTranslationAnchor`
 property.
 */
...
/**
 An `MZGLFillStyleLayer` is a style layer that renders one or more filled (and
 ...
 `MZGLVectorTileSource` object, or they can be `MZGLPolygon`, `MZGLPolygonFeature`,
 `MGLMultiPolygon`, or `MGLMultiPolygonFeature` instances in an `MZGLShapeSource`
 or `MZGLComputedShapeSource` object.
 ...
 the `fillOpacity` of an `MZGLFillStyleLayer` object. See the <a
 ...
 features styled by a `MZGLFillStyleLayer`.

 ### Example

 ```swift
 let layer = MZGLFillStyleLayer(identifier: "parks", source: parks)
 ...
 */
MGL_EXPORT
@interface MZGLFillStyleLayer : MZGLVectorStyleLayer
...
/**
 ...
 `MZGLFillStyleLayer` object and unwrapping its raw value.
 */
@interface NSValue (MZGLFillStyleLayerAdditions)
