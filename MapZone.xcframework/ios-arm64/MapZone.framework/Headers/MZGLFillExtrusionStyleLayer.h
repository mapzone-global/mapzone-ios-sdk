...
/**
 ...
 `MZGLFillExtrusionStyleLayer.fillExtrusionTranslation`.

 Values of this type are used in the `MZGLFillExtrusionStyleLayer.fillExtrusionTranslationAnchor`
 property.
 */
...
/**
 An `MZGLFillExtrusionStyleLayer` is a style layer that renders one or more 3D
 ...
 an `MZGLVectorTileSource` object, or they can be `MZGLPolygon`,
 `MZGLPolygonFeature`, `MGLMultiPolygon`, or `MGLMultiPolygonFeature` instances
 in an `MZGLShapeSource` or `MZGLComputedShapeSource` object.
 ...
 ```swift
 let layer = MZGLFillExtrusionStyleLayer(identifier: "buildings", source: buildings)
 ...
 */
MGL_EXPORT
@interface MZGLFillExtrusionStyleLayer : MZGLVectorStyleLayer
...
/**
 ...
 `MZGLFillExtrusionStyleLayer` object and unwrapping its raw value.
 */
@interface NSValue (MZGLFillExtrusionStyleLayerAdditions)
