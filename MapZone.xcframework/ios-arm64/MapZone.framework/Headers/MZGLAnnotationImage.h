...
/**
 The `MZGLAnnotationImage` class is responsible for presenting point-based
 ...
 as a marker using `MZGLAnnotationImage`. 
 */
MGL_EXPORT
@interface MZGLAnnotationImage : NSObject <NSSecureCoding>
