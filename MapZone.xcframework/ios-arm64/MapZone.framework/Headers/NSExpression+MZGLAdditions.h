...
@class MZGLAttributedExpression;
...
/**
 ...
 Create a heatmap layer</a> example to learn how to style an `MZGLHeatmapStyleLayer`
...
/**
 Returns an attributed function expression specifying an `MZGLAttributedExpression` constant
 expression array.
 
 @param attributedExpressions The `MZGLAttributedExpression` constant expression array.
 */
