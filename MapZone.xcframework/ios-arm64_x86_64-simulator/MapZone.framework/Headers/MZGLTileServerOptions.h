...
/**
 The `MZGLTileServerOptions` defines server properties such as URL etc...
 */
MGL_EXPORT
@interface MZGLTileServerOptions : NSObject
...
* Default styles.
*/
@property (nonatomic, retain) NSArray<MZGLDefaultStyle*>* defaultStyles;

/**
 * Default style
 */
@property (nonatomic, retain) MZGLDefaultStyle* defaultStyle;
