...
#import "MapZone.h"
#import "MZGLCameraChangeReason.h"

NS_ASSUME_NONNULL_BEGIN

@class MZGLMapView;
@class MZGLUserLocationAnnotationViewStyle;

/**
 The `MZGLMapViewDelegate` protocol defines a set of optional methods that you
 can use to receive map-related update messages. Because many map operations
 require the `MZGLMapView` class to load data asynchronously, the map view calls
 ...
 */
@protocol MZGLMapViewDelegate <NSObject>
...
/**
 ...
 and `MZGLMapCamera` objects to restrict a users ability to pan your map.
 */
- (BOOL)mapView:(MZGLMapView *)mapView shouldChangeFromCamera:(MZGLMapCamera *)oldCamera toCamera:(MZGLMapCamera *)newCamera;
 ...
 */
- (BOOL)mapView:(MZGLMapView *)mapView shouldChangeFromCamera:(MZGLMapCamera *)oldCamera toCamera:(MZGLMapCamera *)newCamera reason:(MZGLCameraChangeReason)reason;
 ...
 */
- (void)mapView:(MZGLMapView *)mapView regionWillChangeAnimated:(BOOL)animated;
 ...
 */
- (void)mapView:(MZGLMapView *)mapView regionWillChangeWithReason:(MZGLCameraChangeReason)reason animated:(BOOL)animated;
...
/**
 ...
 as `-[MZGLMapView setCamera:animated:]`. This method can be called before
 ...
 */
- (void)mapViewRegionIsChanging:(MZGLMapView *)mapView;
 ...
 */
- (void)mapView:(MZGLMapView *)mapView regionIsChangingWithReason:(MZGLCameraChangeReason)reason;
 ...
 */
- (void)mapView:(MZGLMapView *)mapView regionDidChangeAnimated:(BOOL)animated;
 ...
 */
- (void)mapView:(MZGLMapView *)mapView regionDidChangeWithReason:(MZGLCameraChangeReason)reason animated:(BOOL)animated;
 ...
 */
- (void)mapViewWillStartLoadingMap:(MZGLMapView *)mapView;
 ...
 */
- (void)mapViewDidFinishLoadingMap:(MZGLMapView *)mapView;
 ...
 */
- (void)mapViewDidFailLoadingMap:(MZGLMapView *)mapView withError:(NSError *)error;

// TODO
- (void)mapViewWillStartRenderingMap:(MZGLMapView *)mapView;

// TODO
- (void)mapViewDidFinishRenderingMap:(MZGLMapView *)mapView fullyRendered:(BOOL)fullyRendered;
 ...
 */
- (void)mapViewWillStartRenderingFrame:(MZGLMapView *)mapView;
 ...
 */
- (void)mapViewDidFinishRenderingFrame:(MZGLMapView *)mapView fullyRendered:(BOOL)fullyRendered;
 ...
 */
- (void)mapViewDidBecomeIdle:(MZGLMapView *)mapView;
 ...
 */
- (void)mapView:(MZGLMapView *)mapView didFinishLoadingStyle:(MZGLStyle *)style;

- (nullable UIImage *)mapView:(MZGLMapView *)mapView didFailToLoadImage:(NSString *)imageName;
...
/**
 ...
 the cached image.
 */
- (BOOL)mapView:(MZGLMapView *)mapView shouldRemoveStyleImage:(NSString *)imageName;
 ...
 */
- (void)mapViewWillStartLocatingUser:(MZGLMapView *)mapView;
...
/**
 ...
 @param mapView The map view that is tracking the user’s location.
 */
- (void)mapViewDidStopLocatingUser:(MZGLMapView *)mapView;
...
/**
 ...
 @param mapView The map view that is tracking the user’s location.
 */
- (MZGLUserLocationAnnotationViewStyle *)mapViewStyleForDefaultUserLocationAnnotationView:(MZGLMapView *)mapView NS_SWIFT_NAME(mapView(styleForDefaultUserLocationAnnotationView:));
 ...
 */
- (void)mapView:(MZGLMapView *)mapView didUpdateUserLocation:(nullable MZGLUserLocation *)userLocation;
...
/**
 ...
 @param error An error object containing the reason why location tracking
    failed.
 */
- (void)mapView:(MZGLMapView *)mapView didFailToLocateUserWithError:(NSError *)error;
...
/**
 ...
 @param animated Whether the change caused an animated effect on the map.
 */
- (void)mapView:(MZGLMapView *)mapView didChangeUserTrackingMode:(MGLUserTrackingMode)mode animated:(BOOL)animated;
...
/**
 ...
 This method will override any values set by `MZGLMapView.userLocationVerticalAlignment`
 or `-[MZGLMapView setUserLocationVerticalAlignment:animated:]`.

 @param mapView The map view that is tracking the user's location.
 */
- (CGPoint)mapViewUserLocationAnchorPoint:(MZGLMapView *)mapView;
 ...
 */
- (void)mapView:(MZGLMapView *)mapView didChangeLocationManagerAuthorization:(id<MZGLLocationManager>)manager API_AVAILABLE(ios(14));
...
/**
 ...
 image should be used for `MZGLAnnotation` objects that have been added to
 your map.
 */
- (nullable MZGLAnnotationImage *)mapView:(MZGLMapView *)mapView imageForAnnotation:(id <MZGLAnnotation>)annotation;
 ...
 */
- (CGFloat)mapView:(MZGLMapView *)mapView alphaForShapeAnnotation:(MZGLShape *)annotation;
...
/**
 ...
 `MZGLShape` object that has been added to your map as an annotation.
 */
- (UIColor *)mapView:(MZGLMapView *)mapView strokeColorForShapeAnnotation:(MZGLShape *)annotation;
...
/**
 ...
 `MZGLPolygon` at runtime.
 */
- (UIColor *)mapView:(MZGLMapView *)mapView fillColorForPolygonAnnotation:(MZGLPolygon *)annotation;
...
/**
 ...
 line width of an `MZGLPolylineFeature` on your map.
 */
- (CGFloat)mapView:(MZGLMapView *)mapView lineWidthForPolylineAnnotation:(MZGLPolyline *)annotation;
...
/**
 ...
 `annotation` is an instance of `MZGLUserLocation` (or equal to the map view’s
 `userLocation` property), return an instance of `MZGLUserLocationAnnotationView`
 ...
 `MGLViewAnnotation` to use for a given `MZGLPointAnnotation` object on your
 map.
 */
- (nullable MZGLAnnotationView *)mapView:(MZGLMapView *)mapView viewForAnnotation:(id <MZGLAnnotation>)annotation;
...
/**
 ...
 @param annotationViews An array of `MZGLAnnotationView` objects representing the
    views that were added.
 */
- (void)mapView:(MZGLMapView *)mapView didAddAnnotationViews:(NSArray<MZGLAnnotationView *> *)annotationViews;
 ...
 */
- (BOOL)mapView:(MZGLMapView *)mapView shapeAnnotationIsEnabled:(MZGLShape *)annotation;
 ...
 */
- (void)mapView:(MZGLMapView *)mapView didSelectAnnotation:(id <MZGLAnnotation>)annotation;
 ...
 */
- (void)mapView:(MZGLMapView *)mapView didDeselectAnnotation:(id <MZGLAnnotation>)annotation;
 ...
 */
- (void)mapView:(MZGLMapView *)mapView didSelectAnnotationView:(MZGLAnnotationView *)annotationView;
 ...
 */
- (void)mapView:(MZGLMapView *)mapView didDeselectAnnotationView:(MZGLAnnotationView *)annotationView;
...
/**
 ...
 `MZGLAnnotation` objects.
 */
- (BOOL)mapView:(MZGLMapView *)mapView annotationCanShowCallout:(id <MZGLAnnotation>)annotation;
...
/**
 ...
 @param annotation The object representing the annotation.
 @return A view conforming to the `MZGLCalloutView` protocol, or `nil` to use the
 ...
 `MZGLAnnotation` object's `MZGLCalloutView`.
 */
- (nullable id <MZGLCalloutView>)mapView:(MZGLMapView *)mapView calloutViewForAnnotation:(id <MZGLAnnotation>)annotation;
 ...
 */
- (nullable UIView *)mapView:(MZGLMapView *)mapView leftCalloutAccessoryViewForAnnotation:(id <MZGLAnnotation>)annotation;
 ...
 */
- (nullable UIView *)mapView:(MZGLMapView *)mapView rightCalloutAccessoryViewForAnnotation:(id <MZGLAnnotation>)annotation;
...
/**
 ...
 custom accessory views using the `MZGLCalloutView` protocol’s
 ...
 */
- (void)mapView:(MZGLMapView *)mapView annotation:(id <MZGLAnnotation>)annotation calloutAccessoryControlTapped:(UIControl *)control;
...
/**
 ...
 `-[MZGLCalloutViewDelegate calloutViewTapped:]` method.
 ...
 action when an `MZGLAnnotation`s `MZGLCalloutView` is tapped.
 */
- (void)mapView:(MZGLMapView *)mapView tapOnCalloutForAnnotation:(id <MZGLAnnotation>)annotation;
