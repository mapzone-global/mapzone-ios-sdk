...
/**
 ...
 Values of this type are used in the `MZGLHillshadeStyleLayer.hillshadeIlluminationAnchor`
 property.
 */
...
/**
 An `MZGLHillshadeStyleLayer` is a style layer that renders raster <a
 ...
 loaded by an `MZGLRasterDEMSource` object. For example, you could use a
 ...
 source, use an `MZGLVectorTileSource` object in conjunction with several
 `MZGLFillStyleLayer` objects.
 ...
 ```swift
 let layer = MZGLHillshadeStyleLayer(identifier: "hills", source: source)
 ...
 */
MGL_EXPORT
@interface MZGLHillshadeStyleLayer : MZGLForegroundStyleLayer
...
/**
 ...
 `MZGLHillshadeStyleLayer` object and unwrapping its raw value.
 */
@interface NSValue (MZGLHillshadeStyleLayerAdditions)
