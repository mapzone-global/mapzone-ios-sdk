...
/**
 `MZGLVectorStyleLayer` is an abstract superclass for style layers whose content
 is defined by an `MZGLShapeSource` or `MZGLVectorTileSource` object.

 Create instances of `MZGLCircleStyleLayer`, `MZGLFillStyleLayer`,
 `MZGLFillExtrusionStyleLayer`, `MZGLHeatmapStyleLayer`, `MZGLLineStyleLayer`, and
 `MZGLSymbolStyleLayer` in order to use `MZGLVectorStyleLayer`'s properties and
 methods. Do not create instances of `MZGLVectorStyleLayer` directly, and do not
 create your own subclasses of this class.
 */
MGL_EXPORT
@interface MZGLVectorStyleLayer : MZGLForegroundStyleLayer
...
/**
 ...
 ```swift
 let layer = MZGLLineStyleLayer(identifier: "contour", source: terrain)
