...
/**
 ...
 Values of this type are used in the `MZGLLineStyleLayer.lineCap`
 property.
 */
...
/**
 ...
 Values of this type are used in the `MZGLLineStyleLayer.lineJoin`
 property.
 */
...
/**
 Controls the frame of reference for `MZGLLineStyleLayer.lineTranslation`.

 Values of this type are used in the `MZGLLineStyleLayer.lineTranslationAnchor`
 property.
 */
...
/**
 An `MZGLLineStyleLayer` is a style layer that renders one or more stroked
 ...
 `MZGLVectorTileSource` object, or they can be `MZGLPolyline`,
 `MZGLPolylineFeature`, `MGLMultiPolyline`, or `MGLMultiPolylineFeature`
 instances in an `MZGLShapeSource` or `MZGLComputedShapeSource` object.
 ...
 an `MZGLMapView` object at runtime.

 ### Example

 ```swift
 let layer = MZGLLineStyleLayer(identifier: "trails-path", source: trails)
 ...
 */
MGL_EXPORT
@interface MZGLLineStyleLayer : MZGLVectorStyleLayer
...
/**
 ...
 effect on lines defined by an `MZGLShapeSource` whose
 `MZGLShapeSourceOptionLineDistanceMetrics` option is set to `YES`.
...
/**
 ...
 `MZGLLineStyleLayer` object and unwrapping its raw value.
 */
@interface NSValue (MZGLLineStyleLayerAdditions)
