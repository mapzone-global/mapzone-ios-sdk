...
/**
 An `MZGLMapCamera` object represents a viewpoint from which the user observes
 some point on an `MZGLMapView`.
 ...
 panning using `MZGLMapViewDelegate`'s
`-mapView:shouldChangeFromCamera:toCamera:` method.
 */
MGL_EXPORT
@interface MZGLMapCamera : NSObject <NSSecureCoding, NSCopying>
...
/**
 ...
 @return A Boolean value indicating whether the two cameras are functionally
    equivalent.
 */
- (BOOL)isEqualToMapCamera:(MZGLMapCamera *)otherCamera;
