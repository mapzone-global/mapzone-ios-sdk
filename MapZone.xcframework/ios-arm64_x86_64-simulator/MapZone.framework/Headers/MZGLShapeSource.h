...
/**
 Options for `MZGLShapeSource` objects.
 */
typedef NSString *MZGLShapeSourceOption NS_STRING_ENUM;
...
/**
 ...
 This option only affects point features within an `MZGLShapeSource` object; it
 is ignored when creating an `MZGLComputedShapeSource` object.

 #### Related examples
 See the <a href="https://docs.mapbox.com/ios/maps/examples/clustering/">Cluster point data</a> and <a href="https://docs.mapbox.com/ios/maps/examples/clustering-with-images/">Use images to cluster point data</a> examples to learn how to cluster point data with this `MZGLShapeSourceOption`.
 */
FOUNDATION_EXTERN MGL_EXPORT const MZGLShapeSourceOption MZGLShapeSourceOptionClustered;
...
/**
 ...
 is ignored when creating an `MZGLComputedShapeSource` object.
 */
FOUNDATION_EXTERN MGL_EXPORT const MZGLShapeSourceOption MZGLShapeSourceOptionClusterRadius;
...
/**
 ...
 let options : [MZGLShapeSourceOption : Any] = [.clustered : true,
 ...
 is ignored when creating an `MZGLComputedShapeSource` object.
 */
FOUNDATION_EXTERN MGL_EXPORT const MZGLShapeSourceOption MZGLShapeSourceOptionClusterProperties;
/**
 An `NSNumber` object containing an integer; specifies the maximum zoom level at
 which to cluster points if clustering is enabled. Defaults to one zoom level
 less than the value of `MZGLShapeSourceOptionMaximumZoomLevel` so that, at the
 ...
 is ignored when creating an `MZGLComputedShapeSource` object.
 */
FOUNDATION_EXTERN MGL_EXPORT const MZGLShapeSourceOption MZGLShapeSourceOptionMaximumZoomLevelForClustering;
...
/**
 ...
 source property in the Mapbox Style Specification.
 */
FOUNDATION_EXTERN MGL_EXPORT const MZGLShapeSourceOption MZGLShapeSourceOptionMinimumZoomLevel;
...
/**
 ...
 source property in the Mapbox Style Specification.
 */
FOUNDATION_EXTERN MGL_EXPORT const MZGLShapeSourceOption MZGLShapeSourceOptionMaximumZoomLevel;
...
/**
 ...
 source property in the Mapbox Style Specification.
 */
FOUNDATION_EXTERN MGL_EXPORT const MZGLShapeSourceOption MZGLShapeSourceOptionBuffer;
...
/**
 ...
 source property in the Mapbox Style Specification.
 */
FOUNDATION_EXTERN MGL_EXPORT const MZGLShapeSourceOption MZGLShapeSourceOptionSimplificationTolerance;

/**
 An `NSNumber` object containing a Boolean enabling or disabling calculating line distance metrics. 
 
 Set this property to `YES` in order for the `MZGLLineStyleLayer.lineGradient` property to have its intended effect.
 ...
 source property in the Mapbox Style Specification.
 */
FOUNDATION_EXTERN MGL_EXPORT const MZGLShapeSourceOption MZGLShapeSourceOptionLineDistanceMetrics;

/**
 `MZGLShapeSource` is a map content source that supplies vector shapes to be
 shown on the map. The shapes may be instances of `MZGLShape` or `MZGLFeature`,
 ...
 `MZGLShapeSource` is optimized for data sets that change dynamically and fit
 completely in memory. For large data sets that do not fit completely in memory,
 use the `MZGLComputedShapeSource` or `MZGLVectorTileSource` class.

 Each
 <a href="https://www.mapbox.com/mapbox-gl-style-spec/#sources-geojson"><code>geojson</code></a>
 source defined by the style JSON file is represented at runtime by an
 `MZGLShapeSource` object that you can use to refine the map’s content and
 initialize new style layers. You can also add and remove sources dynamically
 using methods such as `-[MZGLStyle addSource:]` and
 `-[MZGLStyle sourceWithIdentifier:]`.
 ...
 let polyline = MZGLPolylineFeature(coordinates: &coordinates, count: UInt(coordinates.count))
 let source = MZGLShapeSource(identifier: "lines", features: [polyline], options: nil)
 mapView.style?.addSource(source)
 ```
 
 #### Related examples
 See the <a href="https://docs.mapbox.com/ios/maps/examples/clustering/">Cluster point data</a>, <a href="https://docs.mapbox.com/ios/maps/examples/clustering-with-images/">Use images to cluster point data</a>, and <a href="https://docs.mapbox.com/ios/maps/examples/live-data/">Add live data</a> examples to learn how to add data to your map using this `MZGLSource` object.
 */
MGL_EXPORT
@interface MZGLShapeSource : MZGLSource
...
/**
 ...
 This class supports the following options: `MZGLShapeSourceOptionClustered`,
 `MZGLShapeSourceOptionClusterRadius`,
 `MZGLShapeSourceOptionMaximumZoomLevelForClustering`,
 `MZGLShapeSourceOptionMinimumZoomLevel`, `MZGLShapeSourceOptionMaximumZoomLevel`,
 `MZGLShapeSourceOptionBuffer`, and
 `MZGLShapeSourceOptionSimplificationTolerance`. Shapes provided by a shape
 ...
 updating the an `MZGLShapeSource` object's `URL` property.
 */
- (instancetype)initWithIdentifier:(NSString *)identifier URL:(NSURL *)url options:(nullable NSDictionary<MZGLShapeSourceOption, id> *)options NS_DESIGNATED_INITIALIZER;
...
/**
 ...
 To specify attributes about the shape, use an instance of an `MZGLShape`
 subclass that conforms to the `MZGLFeature` protocol, such as `MGLPointFeature`.
 To include multiple shapes in the source, use an `MZGLShapeCollection` or
 `MZGLShapeCollectionFeature` object, or use the
 ...
 `+[MZGLShape shapeWithData:encoding:error:]` method.

 @param identifier A string that uniquely identifies the source.
 @param shape A concrete subclass of `MZGLShape`
 @param options An `NSDictionary` of options for this source.
 @return An initialized shape source.
 ...
 updating an `MZGLShapeSource`'s `shape` attribute.
 */
- (instancetype)initWithIdentifier:(NSString *)identifier shape:(nullable MZGLShape *)shape options:(nullable NSDictionary<MZGLShapeSourceOption, id> *)options NS_DESIGNATED_INITIALIZER;
...
/**
 ...
 Unlike `-initWithIdentifier:shapes:options:`, this method accepts `MZGLFeature`
 instances, such as `MGLPointFeature` objects, whose attributes you can use when
 applying a predicate to `MZGLVectorStyleLayer` or configuring a style layer’s
 appearance.
 ...
 @param identifier A string that uniquely identifies the source.
 @param features An array of objects that conform to the MZGLFeature protocol.
 @param options An `NSDictionary` of options for this source.
 @return An initialized shape source.
 */
- (instancetype)initWithIdentifier:(NSString *)identifier features:(NSArray<MZGLShape<MZGLFeature> *> *)features options:(nullable NSDictionary<MZGLShapeSourceOption, id> *)options;
...
/**
 ...
 Any `MZGLFeature` instance passed into this initializer is treated as an ordinary
 shape, causing any attributes to be inaccessible to an `MZGLVectorStyleLayer` when
 ...
 @param identifier A string that uniquely identifies the source.
 @param shapes An array of shapes; each shape is a member of a concrete subclass of MZGLShape.
 @param options An `NSDictionary` of options for this source.
 @return An initialized shape source.
 */
- (instancetype)initWithIdentifier:(NSString *)identifier shapes:(NSArray<MZGLShape *> *)shapes options:(nullable NSDictionary<MZGLShapeSourceOption, id> *)options;
...
/**
 ...
 passed into `-[MZGLStyle addSource:]`.
 ...
 */
@property (nonatomic, copy, nullable) MZGLShape *shape;
...
/**
 ...
 `-[MZGLMapView visibleFeaturesAtPoint:inStyleLayersWithIdentifiers:predicate:]`
 or
 `-[MZGLMapView visibleFeaturesInRect:inStyleLayersWithIdentifiers:predicate:]`
 method.
 ...
 */
- (NSArray<id <MZGLFeature>> *)featuresMatchingPredicate:(nullable NSPredicate *)predicate;
...
/**
 ...
 @param cluster An object of type `MGLPointFeatureCluster` (that conforms to the `MZGLCluster` protocol).
 @param offset Number of features to skip.
 @param limit The maximum number of features to return
 
 @return An array of objects that conform to the `MZGLFeature` protocol.
 */
- (NSArray<id <MZGLFeature>> *)leavesOfCluster:(MGLPointFeatureCluster *)cluster offset:(NSUInteger)offset limit:(NSUInteger)limit;
...
/**
 ...
 the `MZGLCluster` protocol (currently only objects of type `MGLPointFeatureCluster`).
 ...
 @note The returned array may contain the `cluster` that was passed in, if the next
    ...
    `-[MZGLShapeSource zoomLevelForExpandingCluster:]`.
 */
- (NSArray<id<MZGLFeature>> *)childrenOfCluster:(MGLPointFeatureCluster *)cluster;
