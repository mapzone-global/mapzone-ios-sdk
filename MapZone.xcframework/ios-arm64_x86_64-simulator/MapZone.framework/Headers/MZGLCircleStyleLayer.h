...
/**
 ...
 Values of this type are used in the `MZGLCircleStyleLayer.circlePitchAlignment`
 property.
 */
...
/**
 ...
 Values of this type are used in the `MZGLCircleStyleLayer.circleScaleAlignment`
 property.
 */
...
/**
 Controls the frame of reference for `MZGLCircleStyleLayer.circleTranslation`.

 Values of this type are used in the `MZGLCircleStyleLayer.circleTranslationAnchor`
 property.
 */
...
/**
 An `MZGLCircleStyleLayer` is a style layer that renders one or more filled
 circles on the map.
 ...
 `MZGLVectorTileSource` object, or they can be `MZGLPointAnnotation`,
 `MGLPointFeature`, `MZGLPointCollection`, or `MZGLPointCollectionFeature`
 ...
 ```swift
 let layer = MZGLCircleStyleLayer(identifier: "circles", source: population)
 ...
 */
MGL_EXPORT
@interface MZGLCircleStyleLayer : MZGLVectorStyleLayer
...
/**
 ...
 `MZGLCircleStyleLayer` object and unwrapping its raw value.
 */
@interface NSValue (MZGLCircleStyleLayerAdditions)
