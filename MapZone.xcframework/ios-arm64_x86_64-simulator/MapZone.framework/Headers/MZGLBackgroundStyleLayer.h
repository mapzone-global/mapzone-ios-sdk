...
/**
 An `MZGLBackgroundStyleLayer` is a style layer that covers the entire map. Use a
 ...
 other bodies of water are drawn by `MZGLFillStyleLayer` objects.
 ...
 access it by getting the last item in the `MZGLStyle.layers` array.
 ...
 */
MGL_EXPORT
@interface MZGLBackgroundStyleLayer : MZGLStyleLayer
