...
/**
 ...
 use the MZGLShapeOfflineRegion class instead.
 ...
 let region = MZGLTilePyramidOfflineRegion(styleURL: MZGLStyle.lightStyleURL, bounds: bbox, fromZoomLevel: 11, toZoomLevel: 14)
 ...
 */
MGL_EXPORT
@interface MZGLTilePyramidOfflineRegion : NSObject <MZGLOfflineRegion, NSSecureCoding, NSCopying>
...
/**
 ...
 This is the designated initializer for `MZGLTilePyramidOfflineRegion`.
