...
/**
 ...
 Values of this type are used in the `MZGLSymbolStyleLayer.iconAnchor`
 property.
 */
...
/**
 ...
 Values of this type are used in the `MZGLSymbolStyleLayer.iconPitchAlignment`
 property.
 */
typedef NS_ENUM(NSUInteger, MGLIconPitchAlignment) {
    ...
    /**
     ...
     `MZGLSymbolStyleLayer.iconRotationAlignment`.
     */
    MGLIconPitchAlignmentAuto,
};

/**
 In combination with `MZGLSymbolStyleLayer.symbolPlacement`, determines the
 rotation behavior of icons.

 Values of this type are used in the `MZGLSymbolStyleLayer.iconRotationAlignment`
 property.
 */
typedef NS_ENUM(NSUInteger, MGLIconRotationAlignment) {
    ...
    /**
     ...
     regardless of the value of `MZGLSymbolStyleLayer.symbolPlacement`.
     */
...
/**
 ...
 Values of this type are used in the `MZGLSymbolStyleLayer.iconTextFit`
 property.
 */
...
/**
 ...
 Values of this type are used in the `MZGLSymbolStyleLayer.symbolPlacement`
 property.
 */
...
/**
 ...
 Values of this type are used in the `MZGLSymbolStyleLayer.symbolZOrder`
 property.
 */
typedef NS_ENUM(NSUInteger, MGLSymbolZOrder) {
    /**
     If `MZGLSymbolStyleLayer.symbolSortKey` is set, sort based on that.
...
/**
 ...
 Values of this type are used in the `MZGLSymbolStyleLayer.textAnchor`
 property.
 */
...
/**
 ...
 Values of this type are used in the `MZGLSymbolStyleLayer.textJustification`
 property.
 */
...
/**
 ...
 Values of this type are used in the `MZGLSymbolStyleLayer.textPitchAlignment`
 property.
 */
typedef NS_ENUM(NSUInteger, MGLTextPitchAlignment) {
    ...
    /**
     Automatically matches the value of
     `MZGLSymbolStyleLayer.textRotationAlignment`.
     */
...
/**
 ...
 Values of this type are used in the `MZGLSymbolStyleLayer.textRotationAlignment`
 property.
 */
...
/**
 ...
 Values of this type are used in the `MZGLSymbolStyleLayer.textTransform`
 property.
 */
...
/**
 ...
 Values of this type are used in the `MZGLSymbolStyleLayer.textWritingModes`
 property.
 */
...
/**
 Controls the frame of reference for `MZGLSymbolStyleLayer.iconTranslation`.

 Values of this type are used in the `MZGLSymbolStyleLayer.iconTranslationAnchor`
 property.
 */
...
/**
 Controls the frame of reference for `MZGLSymbolStyleLayer.textTranslation`.

 Values of this type are used in the `MZGLSymbolStyleLayer.textTranslationAnchor`
 property.
 */
...
/**
 An `MZGLSymbolStyleLayer` is a style layer that renders icon and text labels at
 points or along lines on the map.
 
 Use a symbol style layer to configure the visual appearance of feature labels.
 These features can come from vector tiles loaded by an `MZGLVectorTileSource`
 object, or they can be `MZGLShape` or `MZGLFeature` instances in an
 `MZGLShapeSource` or `MZGLComputedShapeSource` object.

 You can access an existing symbol style layer using the
 `-[MZGLStyle layerWithIdentifier:]` method if you know its identifier;
 otherwise, find it using the `MZGLStyle.layers` property. You can also create a
 ...
 ```swift
 let layer = MZGLSymbolStyleLayer(identifier: "coffeeshops", source: pois)
 ...
 */
MGL_EXPORT
@interface MZGLSymbolStyleLayer : MZGLVectorStyleLayer

/**
 Returns a symbol style layer initialized with an identifier and source.

 After initializing and configuring the style layer, add it to a map view’s
 style using the `-[MZGLStyle addLayer:]` or
 `-[MZGLStyle insertLayer:belowLayer:]` method.
 ...
 */
- (instancetype)initWithIdentifier:(NSString *)identifier source:(MZGLSource *)source;
...
/**
 ...
 Use the `+[MZGLStyle setImage:forName:]` method to associate an image with a
...
/**
 ...
 `MZGLSymbolStyleLayer` object and unwrapping its raw value.
 */
@interface NSValue (MZGLSymbolStyleLayerAdditions)
