...
@class MZGLAnnotationView;
@class MZGLAnnotationImage;
@class MZGLUserLocation;
@class MZGLMapProjection;
@class MZGLPolyline;
@class MZGLPolygon;
@class MZGLShape;

@protocol MZGLMapViewDelegate;
@protocol MZGLAnnotation;
@protocol MZGLOverlay;
@protocol MZGLCalloutView;
@protocol MZGLFeature;
@protocol MZGLLocationManager;

/** Options for `MZGLMapView.decelerationRate`. */
typedef CGFloat MZGLMapViewDecelerationRate NS_TYPED_EXTENSIBLE_ENUM;

/** The default deceleration rate for a map view. */
FOUNDATION_EXTERN MGL_EXPORT const MZGLMapViewDecelerationRate MZGLMapViewDecelerationRateNormal;

/** A fast deceleration rate for a map view. */
FOUNDATION_EXTERN MGL_EXPORT const MZGLMapViewDecelerationRate MZGLMapViewDecelerationRateFast;

/** Disables deceleration in a map view. */
FOUNDATION_EXTERN MGL_EXPORT const MZGLMapViewDecelerationRate MZGLMapViewDecelerationRateImmediate;

/**
 The vertical alignment of an annotation within a map view. Used with
 `MZGLMapView.userLocationVerticalAlignment`.
 */
typedef NS_ENUM(NSUInteger, MZGLAnnotationVerticalAlignment) {
    /** Aligns the annotation vertically in the center of the map view. */
    MZGLAnnotationVerticalAlignmentCenter = 0,
    /** Aligns the annotation vertically at the top of the map view. */
    MZGLAnnotationVerticalAlignmentTop,
    /** Aligns the annotation vertically at the bottom of the map view. */
    MZGLAnnotationVerticalAlignmentBottom,
};

/**
 The position of scale bar, compass, logo and attribution in a map view. Used with
 `MZGLMapView.scaleBarPosition`,
 `MZGLMapView.compassViewPosition`,
 `MZGLMapView.logoViewPosition`,
 `MZGLMapView.attributionButtonPosition`.
 */
...
/** Options for `MZGLMapView.preferredFramesPerSecond`. */
typedef NSInteger MZGLMapViewPreferredFramesPerSecond NS_TYPED_EXTENSIBLE_ENUM;

/**
 The default frame rate. This can be either 30 FPS or 60 FPS, depending on
 device capabilities.
 */
FOUNDATION_EXTERN MGL_EXPORT const MZGLMapViewPreferredFramesPerSecond MZGLMapViewPreferredFramesPerSecondDefault;

/** A conservative frame rate; typically 30 FPS. */
FOUNDATION_EXTERN MGL_EXPORT const MZGLMapViewPreferredFramesPerSecond MZGLMapViewPreferredFramesPerSecondLowPower;

/** The maximum supported frame rate; typically 60 FPS. */
FOUNDATION_EXTERN MGL_EXPORT const MZGLMapViewPreferredFramesPerSecond MZGLMapViewPreferredFramesPerSecondMaximum;

FOUNDATION_EXTERN MGL_EXPORT MGLExceptionName const MGLMissingLocationServicesUsageDescriptionException;
FOUNDATION_EXTERN MGL_EXPORT MGLExceptionName const MZGLUserLocationAnnotationTypeException;

/**
 An interactive, customizable map view with an interface similar to the one
 provided by Apple’s MapKit.

 Using `MZGLMapView`, you can embed the map inside a view, allow users to
 ...
 A collection of Mapbox-hosted styles is available through the `MZGLStyle`
 ...
 Because `MZGLMapView` loads asynchronously, several delegate methods are available
 ...
 in the `MZGLMapViewDelegate` protocol documentation.

 Adding your own gesture recognizer to `MZGLMapView` will block the corresponding
 gesture recognizer built into `MZGLMapView`. To avoid conflicts, define which
 gesture takes precedence. For example, you can create your own
 `UITapGestureRecognizer` that will be invoked only if the default `MZGLMapView`
 tap gesture fails:
 ...
 Simple map view</a> example to learn how to initialize a basic `MZGLMapView`.
 */
MGL_EXPORT
@interface MZGLMapView : UIView <MGLStylable>
...
/**
 ...
 initialize an `MZGLMapView` with a custom style. See the
 ...
 an `MZGLMapView` with a Studio Classic style _or_ a custom style JSON. See the
 ...
 `MZGLMapView` with a third-party tile source.
 */
...
/**
 ...
 annotations.
 */
@property(nonatomic, weak, nullable) IBOutlet id<MZGLMapViewDelegate> delegate;
...
/**
 ...
 `-[MZGLMapViewDelegate mapView:didFinishLoadingStyle:]` or
 `-[MZGLMapViewDelegate mapViewDidFinishLoadingMap:]` method. It is not possible
 ...
 @note The default styles provided by Mapbox contain sources and layers with
    ...
    `+[MZGLStyle outdoorsStyleURLWithVersion:]`, `MZGLMapView`’s “Style URL”
    inspectable in Interface Builder, or a manually constructed `NSURL`.
 */
@property (nonatomic, readonly, nullable) MZGLStyle *style;
 ...
 */
@property (nonatomic, readonly) MZGLCompassButton *compassView;
...
/**
 ...
 `MZGLMapViewPreferredFramesPerSecondDefault`, which will adaptively set the
 preferred frame rate based on the capability of the user’s device to maintain
 a smooth experience.

 In addition to the provided `MZGLMapViewPreferredFramesPerSecond` options, this
 property can be set to arbitrary integer values.

 @see `CADisplayLink.preferredFramesPerSecond`
 */
@property (nonatomic, assign) MZGLMapViewPreferredFramesPerSecond preferredFramesPerSecond;
...
/**
 ...
 `-[MZGLMapViewDelegate mapView:didUpdateUserLocation:]` and
 `-[MZGLMapViewDelegate mapView:didFailToLocateUserWithError:]` methods.

 If setting this property to `nil` or if no custom manager is provided this
 property is set to the default location manager.

 `MZGLMapView` uses a default location manager. If you want to substitute your
 ...
 */
@property (nonatomic, null_resettable) id<MZGLLocationManager> locationManager;
 ...
 */
@property (nonatomic, readonly, nullable) MZGLUserLocation *userLocation;
...
/**
 ...
 default value is `MZGLAnnotationVerticalAlignmentCenter`.

 Changing the value of this property updates the map view with an animated
 transition. If you don’t want to animate the change, use the
 `-setUserLocationVerticalAlignment:animated:` method instead.
 */
@property (nonatomic, assign) MZGLAnnotationVerticalAlignment userLocationVerticalAlignment __attribute__((deprecated("Use `-[MZGLMapViewDelegate mapViewUserLocationAnchorPoint:]` instead.")));
 ...
 */
- (void)setUserLocationVerticalAlignment:(MZGLAnnotationVerticalAlignment)alignment animated:(BOOL)animated __attribute__((deprecated("Use `-[MZGLMapViewDelegate mapViewUserLocationAnchorPoint:]` instead.")));
...
/**
 ...
 Your application can use the `MZGLMapViewDecelerationRateNormal` and
 `MZGLMapViewDecelerationRateFast` constants as reference points for reasonable
 deceleration rates. `MZGLMapViewDecelerationRateImmediate` can be used to
 ...
 */
- (void)showAnnotations:(NSArray<id <MZGLAnnotation>> *)annotations animated:(BOOL)animated;
...
/**
 ...
 @param animated `YES` if you want the map region change to be animated, or `NO`
    if you want the map to display the new region immediately without animations.
 */
- (void)showAnnotations:(NSArray<id <MZGLAnnotation>> *)annotations edgePadding:(UIEdgeInsets)insets animated:(BOOL)animated __attribute__((deprecated("Use `-showAnnotations:edgePadding:animated:completionHandler:` instead.")));
...
/**
 ...
 @param completion The block executed after the animation finishes.
 */
- (void)showAnnotations:(NSArray<id <MZGLAnnotation>> *)annotations edgePadding:(UIEdgeInsets)insets animated:(BOOL)animated completionHandler:(nullable void (^)(void))completion;

/**
 A camera representing the current viewpoint of the map.
 */
@property (nonatomic, copy) MZGLMapCamera *camera;
 ...
 */
- (void)setCamera:(MZGLMapCamera *)camera animated:(BOOL)animated;
 ...
 */
- (void)setCamera:(MZGLMapCamera *)camera withDuration:(NSTimeInterval)duration animationTimingFunction:(nullable CAMediaTimingFunction *)function;
 ...
 */
- (void)setCamera:(MZGLMapCamera *)camera withDuration:(NSTimeInterval)duration animationTimingFunction:(nullable CAMediaTimingFunction *)function completionHandler:(nullable void (^)(void))completion;
...
/**
 ...
 @param completion The block to execute after the animation finishes.
 */
- (void)setCamera:(MZGLMapCamera *)camera withDuration:(NSTimeInterval)duration animationTimingFunction:(nullable CAMediaTimingFunction *)function edgePadding:(UIEdgeInsets)edgePadding completionHandler:(nullable void (^)(void))completion;
...
/**
 ...
 @param completion The block to execute after the animation finishes.
 */
- (void)flyToCamera:(MZGLMapCamera *)camera completionHandler:(nullable void (^)(void))completion;
...
/**
 ...
 @param completion The block to execute after the animation finishes.
 */
- (void)flyToCamera:(MZGLMapCamera *)camera withDuration:(NSTimeInterval)duration completionHandler:(nullable void (^)(void))completion;
...
/**
 ...
 @param completion The block to execute after the animation finishes.
 */
- (void)flyToCamera:(MZGLMapCamera *)camera withDuration:(NSTimeInterval)duration peakAltitude:(CLLocationDistance)peakAltitude completionHandler:(nullable void (^)(void))completion;
 ...
 */
- (MZGLMapCamera *)cameraThatFitsCoordinateBounds:(MGLCoordinateBounds)bounds;
...
/**
 ...
 depending on the order of notification delivery.
 */
- (MZGLMapCamera *)cameraThatFitsCoordinateBounds:(MGLCoordinateBounds)bounds edgePadding:(UIEdgeInsets)insets;
...
/**
 ...
 depending on the order of notification delivery.
 */
- (MZGLMapCamera *)camera:(MZGLMapCamera *)camera fittingCoordinateBounds:(MGLCoordinateBounds)bounds edgePadding:(UIEdgeInsets)insets;
...
/**
 ...
 depending on the order of notification delivery.
 */
- (MZGLMapCamera *)camera:(MZGLMapCamera *)camera fittingShape:(MZGLShape *)shape edgePadding:(UIEdgeInsets)insets;
...
/**
 ...
 depending on the order of notification delivery.
 */
- (MZGLMapCamera *)cameraThatFitsShape:(MZGLShape *)shape direction:(CLLocationDirection)direction edgePadding:(UIEdgeInsets)insets;
...
/**
 ...
 use the map view’s property `MZGLMapView.automaticallyAdjustsContentInset`instead.
 ...
 */
- (MZGLMapProjection*)mapProjection;
...
/**
 ...
 The objects in this array must adopt the `MZGLAnnotation` protocol. If no
 annotations are associated with the map view, the value of this property is
 `nil`.
 */
@property (nonatomic, readonly, nullable) NSArray<id <MZGLAnnotation>> *annotations;

/**
 Adds an annotation to the map view.

 @note `MGLMultiPolyline`, `MGLMultiPolygon`, `MZGLShapeCollection`, and
    `MZGLPointCollection` objects cannot be added to the map view at this time.
 ...
 @param annotation The annotation object to add to the receiver. This object
    must conform to the `MZGLAnnotation` protocol. The map view retains the
    annotation object.
 ...
 annotation to an `MZGLMapView` object.
 */
- (void)addAnnotation:(id <MZGLAnnotation>)annotation;

/**
 Adds an array of annotations to the map view.

 @note `MGLMultiPolyline`, `MGLMultiPolygon`, and `MZGLShapeCollection` objects
    cannot be added to the map view at this time. Nor can `MZGLMultiPoint`
    objects that are not instances of `MZGLPolyline` or `MZGLPolygon`. Any
    multipoint, multipolyline, multipolygon, or shape collection objects that
    are specified are silently ignored.

 @param annotations An array of annotation objects. Each object in the array
    must conform to the `MZGLAnnotation` protocol. The map view retains each
    individual annotation object.
 */
- (void)addAnnotations:(NSArray<id <MZGLAnnotation>> *)annotations;
...
/**
 ...
 @param annotation The annotation object to remove. This object must conform
    to the `MZGLAnnotation` protocol
 */
- (void)removeAnnotation:(id <MZGLAnnotation>)annotation;
...
/**
 ...
 @param annotations The array of annotation objects to remove. Objects in the
    array must conform to the `MZGLAnnotation` protocol.
 */
- (void)removeAnnotations:(NSArray<id <MZGLAnnotation>> *)annotations;

/**
 Returns an `MZGLAnnotationView` if the given annotation is currently associated
 with a view, otherwise nil.

 @param annotation The annotation associated with the view.
    Annotation must conform to the `MZGLAnnotation` protocol.
 */
- (nullable MZGLAnnotationView *)viewForAnnotation:(id <MZGLAnnotation>)annotation;

/**
 Returns a reusable annotation image object associated with its identifier.

 For performance reasons, you should generally reuse `MZGLAnnotationImage`
 ...
 reuse an `MZGLAnnotationImage`.
 */
- (nullable __kindof MZGLAnnotationImage *)dequeueReusableAnnotationImageWithIdentifier:(NSString *)identifier;

/**
 Returns a reusable annotation view object associated with its identifier.

 For performance reasons, you should generally reuse `MZGLAnnotationView`
 objects for identical-looking annotations in your map views. Dequeueing
 saves time and memory during performance-critical operations such as
 scrolling.
 ...
 @return An annotation view object with the given identifier, or `nil` if no
    such object exists in the reuse queue.
 */
- (nullable __kindof MZGLAnnotationView *)dequeueReusableAnnotationViewWithIdentifier:(NSString *)identifier;
 ...
 */
@property (nonatomic, readonly, nullable) NSArray<id <MZGLAnnotation>> *visibleAnnotations;
...
/**
 ...
 @return An array of objects that adopt the `MZGLAnnotation` protocol or `nil` if
    no annotations associated with the map view are currently visible in the
    rectangle.
 */
- (nullable NSArray<id <MZGLAnnotation>> *)visibleAnnotationsInRect:(CGRect)rect;
...
/**
 ...
 If the annotation is of type `MZGLPointAnnotation` and is offscreen, the camera
 ...
 selected.
 */
@property (nonatomic, copy) NSArray<id <MZGLAnnotation>> *selectedAnnotations;
...
/**
 ...
 | `YES`            | The annotation is selected, and the callout is presented. If the annotation is not visible (or is partially visible) *and* is of type `MZGLPointAnnotation`, the map is panned so that the annotation and its callout are brought into view. The annotation is *not* centered within the viewport. |
 ...
 change the camera.
 */
- (void)selectAnnotation:(id <MZGLAnnotation>)annotation animated:(BOOL)animated __attribute__((deprecated("Use `-selectAnnotation:animated:completionHandler:` instead.")));
...
/**
 ...
 change the camera.
 */
- (void)selectAnnotation:(id <MZGLAnnotation>)annotation animated:(BOOL)animated completionHandler:(nullable void (^)(void))completion;
...
/**
 ...
 @param annotation The annotation object to select.
 @param moveIntoView If the annotation is not visible (or is partially visible) *and* is of type `MZGLPointAnnotation`, the map is panned so that the annotation and its callout are brought into view. The annotation is *not* centered within the viewport.
 @param animateSelection If `YES`, the annotation's selection state and callout view's presentation are animated.
 @param completion The block executed after the animation finishes.
 */
- (void)selectAnnotation:(id <MZGLAnnotation>)annotation moveIntoView:(BOOL)moveIntoView animateSelection:(BOOL)animateSelection completionHandler:(nullable void (^)(void))completion;
 ...
 */
- (void)deselectAnnotation:(nullable id <MZGLAnnotation>)annotation animated:(BOOL)animated;
...
/**
 ...
 The objects in this array must adopt the `MZGLOverlay` protocol. If no
 overlays are associated with the map view, the value of this property is
 empty array.
 */
@property (nonatomic, readonly, nonnull) NSArray<id <MZGLOverlay>> *overlays;
...
/**
 ...
 @param overlay The overlay object to add. This object must conform to the
    `MZGLOverlay` protocol. */
- (void)addOverlay:(id <MZGLOverlay>)overlay;
...
/**
 ...
 @param overlays An array of objects, each of which must conform to the
    `MZGLOverlay` protocol.
 */
- (void)addOverlays:(NSArray<id <MZGLOverlay>> *)overlays;
 ...
 */
- (void)removeOverlay:(id <MZGLOverlay>)overlay;
...
/**
 ...
 @param overlays An array of objects, each of which conforms to the `MZGLOverlay`
    protocol.
 */
- (void)removeOverlays:(NSArray<id <MZGLOverlay>> *)overlays;
...
/**
 ...
 @return An array of objects conforming to the `MZGLFeature` protocol that
 ...
 `MZGLMapView` object for visible `MZGLFeature` objects.
 */
- (NSArray<id <MZGLFeature>> *)visibleFeaturesAtPoint:(CGPoint)point NS_SWIFT_NAME(visibleFeatures(at:));
...
/**
 ...
 @return An array of objects conforming to the `MZGLFeature` protocol that
    represent features in the sources used by the current style.
 */
- (NSArray<id <MZGLFeature>> *)visibleFeaturesAtPoint:(CGPoint)point inStyleLayersWithIdentifiers:(nullable NSSet<NSString *> *)styleLayerIdentifiers NS_SWIFT_NAME(visibleFeatures(at:styleLayerIdentifiers:));
...
/**
 ...
 `MZGLShapeSource` and `MZGLVectorTileSource` objects but does not include
 anything from `MZGLRasterTileSource` objects, or from video or canvas sources,
 ...
 `MZGLFeature` object representing that bus stop is returned and its
 ...
 visibility, use the
 `-[MZGLVectorTileSource featuresInSourceLayersWithIdentifiers:predicate:]` and
 `-[MZGLShapeSource featuresMatchingPredicate:]` methods on the relevant sources.

 The returned features may also include features corresponding to annotations.
 These features are not object-equal to the `MZGLAnnotation` objects that were
 originally added to the map. To query the map for annotations, use
 `visibleAnnotations` or `-[MZGLMapView visibleAnnotationsInRect:]`.

 @note Layer identifiers are not guaranteed to exist across styles or different
    versions of the same style. Applications that use this API must first set
    the style URL to an explicitly versioned style using a convenience method
    like `+[MZGLStyle outdoorsStyleURLWithVersion:]`, `MZGLMapView`’s “Style URL”
 ...
 @return An array of objects conforming to the `MZGLFeature` protocol that
    represent features in the sources used by the current style.
 */
- (NSArray<id <MZGLFeature>> *)visibleFeaturesAtPoint:(CGPoint)point inStyleLayersWithIdentifiers:(nullable NSSet<NSString *> *)styleLayerIdentifiers predicate:(nullable NSPredicate *)predicate NS_SWIFT_NAME(visibleFeatures(at:styleLayerIdentifiers:predicate:));
...
/**
 ...
 @return An array of objects conforming to the `MZGLFeature` protocol that
    represent features in the sources used by the current style.
 */
- (NSArray<id <MZGLFeature>> *)visibleFeaturesInRect:(CGRect)rect NS_SWIFT_NAME(visibleFeatures(in:));
...
/**
 ...
 @return An array of objects conforming to the `MZGLFeature` protocol that
    represent features in the sources used by the current style.
 */
- (NSArray<id <MZGLFeature>> *)visibleFeaturesInRect:(CGRect)rect inStyleLayersWithIdentifiers:(nullable NSSet<NSString *> *)styleLayerIdentifiers NS_SWIFT_NAME(visibleFeatures(in:styleLayerIdentifiers:));
...
/**
 ...
 array. On the other hand, if the style does include bus stops, an `MZGLFeature`
 ...
 @return An array of objects conforming to the `MZGLFeature` protocol that
    represent features in the sources used by the current style.
 */
- (NSArray<id <MZGLFeature>> *)visibleFeaturesInRect:(CGRect)rect inStyleLayersWithIdentifiers:(nullable NSSet<NSString *> *)styleLayerIdentifiers predicate:(nullable NSPredicate *)predicate NS_SWIFT_NAME(visibleFeatures(in:styleLayerIdentifiers:predicate:));
