...
typedef NS_ENUM(NSUInteger, MZGLAnnotationViewDragState) {
    /**
     The view is not involved in a drag operation.
     */
    MZGLAnnotationViewDragStateNone = 0,
    /**
     ...
     */
    MZGLAnnotationViewDragStateEnding,
};

/**
 The `MZGLAnnotationView` class is responsible for marking a point annotation
 with a view. Annotation views represent an annotation object, which is an
 object that corresponds to the `MZGLAnnotation` protocol. When an annotation’s
 ...
 interactivity such as dragging, you can use an `MZGLAnnotationImage` instead to
 conserve memory and optimize drawing performance.
 */
MGL_EXPORT
@interface MZGLAnnotationView : UIView <NSSecureCoding>
...
/**
 ...
 `-[MZGLMapView dequeueReusableAnnotationViewWithIdentifier:]` method.
...
/**
 ...
 with the new view and, in custom subclasses of `MZGLAnnotationView`, customize the view
 ...
 with views when views are provided to the map via the `-[MZGLMapViewDelegate mapView:viewForAnnotation:]`
 method.
 ...
 @return The initialized annotation view object.
 */
- (instancetype)initWithAnnotation:(nullable id<MZGLAnnotation>)annotation reuseIdentifier:(nullable NSString *)reuseIdentifier;
 ...
 */
@property (nonatomic, nullable) id <MZGLAnnotation> annotation;
...
/**
 ...
 viewpoint). This is also the behavior of `MZGLAnnotationImage` objects. When the
...
/**
 ...
 view rotates. This is also the behavior of `MZGLAnnotationImage` objects. When the
...
/**
 ...
 `MZGLAnnotationView` or `MZGLAnnotationImage` object, deselects any currently
 selected view.
...
/**
 ...
 `MZGLAnnotationView`'s behavior when it is selected.
 */
...
/**
 ...
 `MZGLAnnotationView` objects on your map.
 */
 ...
 */
@property (nonatomic, readonly) MZGLAnnotationViewDragState dragState;
 ...
 */
- (void)setDragState:(MZGLAnnotationViewDragState)dragState animated:(BOOL)animated NS_REQUIRES_SUPER;
