...
/**
 The `MZGLLoggingConfiguration` object provides a global way to set this SDK logging levels
 and logging handler.
 */
MGL_EXPORT
@interface MZGLLoggingConfiguration : NSObject
 ...
 */
@property (class, nonatomic, readonly) MZGLLoggingConfiguration *sharedConfiguration;
